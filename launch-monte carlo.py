...
print("=" * 90)
print(
    f"{'sites':<12} {'2023':<6} {'2050 median':<10} {'90% interval':<18} {'capacity':<10} {'technology bottleneck':<10} {'yearly growth':<8}")
print("-" * 90)
...
if high_util_risk:
    for site, prob_80, prob_100 in high_util_risk:
        print(
            f"  • {site}: probability of over 80% utilization {prob_80:.1f}%，probability of over 100% utilization {prob_100:.1f}%")
else:
...
print(
    "   • for every 1% increase in breakthrough probability, cumulative growth over 27 years can increase by about 10-15%")
