"""
MCM 2026 Problem B - Final Version v15
Improvements:
1. Use stable Monte Carlo simulator (provided by user)
2. Enhanced surface effect with strong synergy penalty
3. Separate 3 surface plots with different viewing angles
4. GBK-compatible symbols only
"""
...
class TransportCostTimeModel:
    ...
    def calculate_cost(self, a, p, q):
        ...
        if self.penalty_mode == 'strong':
            ...
            # Mixed penalty formula for extreme effect
...
class Visualizer:
    ...
    def plot_3d_surfaces_separate(model, p_range, q_range, resolution=30, smooth_sigma=0.9):
        ...
        print(f"  - p=1.0, q=0.5: Cost = {cost_corner:.2f} B USD, Time = {time_corner:.1f} years")
...
def main():
    ...
    print("\n" + "-" * 80)
    print("Step 4: Monte Carlo simulation (stable version)")
    print("-" * 80)
    ...
    fig1.savefig('surface_optimal_a_v15.png', dpi=200, bbox_inches='tight')
    print("    Done! surface_optimal_a_v15.png")
    fig2.savefig('surface_time_v15.png', dpi=200, bbox_inches='tight')
    print("    Done! surface_time_v15.png")
    fig3.savefig('surface_cost_v15.png', dpi=200, bbox_inches='tight')
    print("    Done! surface_cost_v15.png")
    
    print("[2/6] Pareto front...")
    fig4 = visualizer.plot_pareto_front(pareto_points, all_a, all_times, all_costs, p, q)
    fig4.savefig('pareto_front_v15.png', dpi=200, bbox_inches='tight')
    print("    Done! pareto_front_v15.png")
    
    print("[3/6] Optimal weights...")
    fig5 = visualizer.plot_optimal_a_vs_weights(weight_results, p, q)
    fig5.savefig('optimal_weights_v15.png', dpi=200, bbox_inches='tight')
    print("    Done! optimal_weights_v15.png")
    
    print("[4/6] Monte Carlo...")
    fig6 = visualizer.plot_monte_carlo_results(mc_results, 0.5)
    fig6.savefig('monte_carlo_v15.png', dpi=200, bbox_inches='tight')
    print("    Done! monte_carlo_v15.png")
